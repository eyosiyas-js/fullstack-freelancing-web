...
import EventImageUpload from '../client/component/Event/EventImageUpload'
import EventView from '../client/component/Event/EventView'
import ListAttendees from '../client/component/Event/ListAttendees'
import EventDelete from '../client/component/Event/EventDelete'
        ...
        >
          ...
          >
                ...
                <div>
                  ...
                  <div className="hide">
                    <MenuItem onClick={handleOpenListAttendees}>
                      <Typography textAlign="center">List attendee</Typography>
                      <img src={listImg} className="HideimgIcon" alt="" />
                    </MenuItem>
                  </div>

                  <div className="hide">
                    <MenuItem onClick={handleOpenUploadImage}>
                      <Typography textAlign="center">Upload image</Typography>
                      <img src={uploadImg} className="UploadimgIcon" alt="" />
                    </MenuItem>
                  </div>
                </div>
              </Menu>
            ...
            <div>
              ...
              >
                <div>
                  <EventDelete open={(open) => setOpen(open)} />
                </div>
              </Modal>
            </div>
